...
config.General.requestName = "MET_Run2018C_mva"
...
config.JobType.scriptArgs = ["isdata=data","year=2018","era=C"] 
config.JobType.sendPythonFolder  = True
config.JobType.allowUndistributedCMSSW = True 

config.section_("Data")
config.Data.inputDataset = "/MET/Run2018C-UL2018_MiniAODv2_NanoAODv9-v1/NANOAOD" 
...
config.Data.outputDatasetTag = "MET_Run2018C_mva" 

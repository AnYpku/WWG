...
config.General.requestName = "DoubleMuon_Run2016G_mva"
...
config.JobType.scriptArgs = ["isdata=data","year=2016","era=G"] 
config.JobType.sendPythonFolder  = True
config.JobType.allowUndistributedCMSSW = True 

config.section_("Data")
config.Data.inputDataset = "/DoubleMuon/Run2016G-UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD" 
...
config.Data.outputDatasetTag = "DoubleMuon_Run2016G_mva" 

...
config.General.requestName = "MET_Run2016H_mva"
...
config.JobType.scriptArgs = ["isdata=data","year=2016","era=H"] 
config.JobType.sendPythonFolder  = True
config.JobType.allowUndistributedCMSSW = True 

config.section_("Data")
config.Data.inputDataset = "/MET/Run2016H-UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD" 
...
config.Data.outputDatasetTag = "MET_Run2016H_mva" 

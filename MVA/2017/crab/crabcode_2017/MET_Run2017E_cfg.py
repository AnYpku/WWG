...
config.General.requestName = "MET_Run2017E_mva"
...
config.JobType.scriptArgs = ["isdata=data","year=2017","era=E"] 
config.JobType.sendPythonFolder  = True
config.JobType.allowUndistributedCMSSW = True 

config.section_("Data")
config.Data.inputDataset = "/MET/Run2017E-UL2017_MiniAODv2_NanoAODv9-v1/NANOAOD" 
...
config.Data.outputDatasetTag = "MET_Run2017E_mva" 

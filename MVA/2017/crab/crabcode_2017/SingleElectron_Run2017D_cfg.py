...
config.General.requestName = "SingleElectron_Run2017D_mva"
...
config.JobType.scriptArgs = ["isdata=data","year=2017","era=D"] 
config.JobType.sendPythonFolder  = True
config.JobType.allowUndistributedCMSSW = True 

config.section_("Data")
config.Data.inputDataset = "/SingleElectron/Run2017D-UL2017_MiniAODv2_NanoAODv9-v1/NANOAOD" 
...
config.Data.outputDatasetTag = "SingleElectron_Run2017D_mva" 

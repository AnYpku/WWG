...
config.General.requestName = "MET_Run2018B_mva"
...
config.JobType.scriptArgs = ["isdata=data","year=2018","era=B"] 
config.JobType.sendPythonFolder  = True
config.JobType.allowUndistributedCMSSW = True 

config.section_("Data")
config.Data.inputDataset = "/MET/Run2018B-UL2018_MiniAODv2_NanoAODv9-v2/NANOAOD" 
...
config.Data.outputDatasetTag = "MET_Run2018B_mva" 

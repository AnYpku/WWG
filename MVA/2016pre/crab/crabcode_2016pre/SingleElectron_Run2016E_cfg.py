...
config.General.requestName = "SingleElectron_Run2016E_mva"
...
config.JobType.scriptArgs = ["isdata=data","year=2016pre","era=E"] 
config.JobType.sendPythonFolder  = True
config.JobType.allowUndistributedCMSSW = True 

config.section_("Data")
config.Data.inputDataset = "/SingleElectron/Run2016E-HIPM_UL2016_MiniAODv2_NanoAODv9-v2/NANOAOD" 
...
config.Data.outputDatasetTag = "SingleElectron_Run2016E_mva" 
